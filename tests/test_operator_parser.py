"""
Unit tests for the operators.operatorparsers module.
...
from pyfes.operators.operatorparsers import OperatorParser
...
class TestOperatorParser(TestCase):
    ...
    def test_parse_property_is_equal_to_operator(self):
        ...
        binary_comparison_operator = OperatorParser.from_xml(
    ...
    def test_parse_property_is_like_operator(self):
        ...
        like_operator = OperatorParser.from_xml(
